...
QT_MOC_LITERAL(3, 24, 3) // "msg"
    ...
    "ClientNetwork\0msgRecvd\0\0msg"
};
...
void ClientNetwork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->msgRecvd((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientNetwork::msgRecvd)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientNetwork::msgRecvd(QString _t1)
{
