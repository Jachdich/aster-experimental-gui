...
CFLAGS        = -pipe -O2 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES) -g
CXXFLAGS      = -pipe -O2 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES) -g
...
COMPRESS      = gzip -9f
DISTNAME      = gui1.0.0
DISTDIR = /home/james/Build/aster/aster-experimental-gui/.tmp/gui1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lssl -lcrypto /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
moc_network.cpp: include/network.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/james/Build/aster/aster-experimental-gui/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/james/Build/aster/aster-experimental-gui -I/home/james/Build/aster/aster-experimental-gui/include -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/9 -I/usr/include/x86_64-linux-gnu/c++/9 -I/usr/include/c++/9/backward -I/usr/lib/gcc/x86_64-linux-gnu/9/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include include/network.h -o moc_network.cpp
...
base64.o: src/base64.cpp include/base64.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o base64.o src/base64.cpp
